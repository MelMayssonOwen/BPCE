...
app_id = "1648306668527238"
app_secret = "ab33c72fcef20887325329149125af19"  # DO NOT SHARE WITH ANYONE!
file_id = "Caisse.Epargne"
...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open('./outputs/facebook_comments_output.csv', 'w') as file:
        w = csv.writer(file)
        ...
        with open('./outputs/facebook_post_output.csv', 'r') as csvfile:
